...
LastEditTime: 2022-03-21 01:39:58
'''
import os
import subprocess
...
def task_launcher(args):
    ...
    with open(os.path.join(root, f'rHz{n_data}_mixup-{mixup}_loss-{loss}_enc-{enc}_nl-{n_layer}_tv-{aux_loss_w:.4f}_id-{id}.log'), 'w') as wfid:
        exp = [
            ...
            # f"--model.mode_list={[(41, 193)]*n_layer}",
...
if __name__ == '__main__':
    ...
    # tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "none", 5, 6, 1]]
    tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "none", 5, 12, 1]]
