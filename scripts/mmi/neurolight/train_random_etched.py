...
LastEditTime: 2022-09-24 19:40:33
'''
import os
import subprocess
...
if __name__ == '__main__':
    ...
    machine = os.uname()[1]
    tasks = [[1, "cmae", True, "tv_loss", 0.005, True, 0.001, "exp", 10, 16, 6]] # 40, 70, dim=64, droppath=0.1, no augpath
