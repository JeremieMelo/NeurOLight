...
LastEditTime: 2022-03-10 01:39:34
'''
import os
import subprocess
...
def task_launcher(args):
    ...
    with open(os.path.join(root, f'rHz{n_data}_mixup-{mixup}_loss-{loss}_enc-{enc}_tv-{aux_loss_w:.4f}_id-{id}.log'), 'w') as wfid:
        exp = [
...
if __name__ == '__main__':
    ...
    tasks = [[1, "cmae", True, "tv_loss", 0.001, True, 0.001, "exp", 5, 1]]
